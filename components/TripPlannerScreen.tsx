...
const TripPlannerScreen = () => {
  ...
  const calculateEta = (distance: number) => {
    const averageSpeed = 70; // Assuming an average speed of 60 km/h
  ...
  const handlePlanNow = () => {
    if (start && finish) {
      ...
      if (distance) {
        setEta(calculateEta(parseFloat(distance)));
      }
    }
    setShowDetails(true);
  };
      ...
      <View style={styles.overlay}>
        ...
        {showDetails && (
          <View style={styles.details}>
            ...
            <TouchableOpacity style={styles.button} onPress={toggleImmersiveView}>
              <Text style={styles.buttonText}>Toggle Immersive View</Text>
            </TouchableOpacity>
            {immersiveView && (
